...
for (let car of inventory) {
  if (car.id === 33) {
    console.log(`Car 33 is a ${car.car_year} ${car.car_model} ${car.car_make}`);
  }
}
...
inventory.forEach(car => {
  if (car.id === 33) {
    console.log(`Car ${car.id} is a ${car.car_year} ${car.car_model} ${car.car_make}`)
  }
})

/// Use find
const car_33 = inventory.find(car => car.id === 33)
console.log(`Car ${car_33.id} is a ${car_33.car_year} ${car_33.car_model} ${car_33.car_make}`)


// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
const lastCar = inventory.find(car => car.id === inventory.length)
console.log(`lastCar ${lastCar.id} is a ${lastCar.car_year} ${lastCar.car_model} ${lastCar.car_make}`)
